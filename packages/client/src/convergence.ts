 ...
 * mutation runtime). The driver is opt-in: pass nothing to `createSyncClient` and no scheduling policy
 * runs — convergence stays fully manual until the app installs one.
 *
