...
| Circuits engine | `ghcr.io/pgxsinkit/electric-circuits/engine:sha-474577a`       | ElectricSQL's Circuits engine, from the pgxsinkit fork. Pinned by **sha tag**, never `main`.                                                     |
