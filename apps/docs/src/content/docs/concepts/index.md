---
title: Core concepts
description: The pgxsinkit mental model in five short pages.
sidebar:
  order: 1
  label: Overview
---

These five pages are the mental model. Read them in order — each builds on the last, and together
