...
4. **Retired experiments are not part of the supported project.** This ADR records
   the resulting decision; no compatibility shims or deprecated aliases preserve
   discarded designs. The supported interface begins at the 0.2.0 baseline.
